...
class FuelTransactionDAO:
    ...
    def insert(self, fuel_id, person_id, tquantity, tunit_price, trans_total):
        cursor = self.conn.cursor()
        query = "insert into fuelTransactions(fuel_id, person_id, tquantity, tunit_price, trans_total) " \
                "values (%s, %s, %s, %s, %s, %s) " \
                "returning fuel_trans_id;"
        cursor.execute(query, (fuel_id, person_id, tquantity, tunit_price, trans_total,))
