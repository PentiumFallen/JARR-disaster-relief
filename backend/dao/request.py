...
class RequestDAO:
    ...
    def insert(self, resource_id, description, needed, unit_price, address, city, zip_code):
        cursor = self.conn.cursor()
        ...
        query = "insert into \"Requests\"(resource_id, rdescription, needed, max_unit_price, " \
                "address_id) values (%s, %s, %s, %s, %s) returning request_id;"
        cursor.execute(query, (resource_id, description, needed, unit_price, address_id))
