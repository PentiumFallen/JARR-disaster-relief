...
class SuppliesDAO:
    ...
    def getAllSupplies(self):
        ...
        query = "select supply_id, scategory, sname, sdescription, saddress, sprice, sfulfilled from supplies;"
    ...
    def getSupplyById(self, sid):
        cursor = self.conn.cursor()
        query = "select supply_id, scategory, sname, sdescription, saddress, sprice, sfulfilled from supplies where supply_id = %s;"
    ...
    def getSuppliesByCategory(self, category):
        cursor = self.conn.cursor()
        query = "select * from supplies where scategory = %s;"
    ...
    def getSuppliesByLocation(self, district):
        cursor = self.conn.cursor()
