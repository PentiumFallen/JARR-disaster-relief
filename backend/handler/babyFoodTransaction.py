...
class BabyFoodTransactionHandler:
    ...
    def build_bf_trans_attributes(self, bf_trans_id, bf_id, person_id, tquantity, tunit_price, trans_total):
        result = {
    ...
    def insertBabyFoodTransaction(self, form):
        ...
        if len(form) != 4:
            ...
            if bf_id and person_id and tquantity and tunit_price:
                dao = BabyFoodTransactionDAO()
                bf_trans_id = dao.insert(bf_id,person_id,tquantity,tunit_price,trans_total)
                result = self.build_bf_trans_attributes(bf_trans_id, bf_id, person_id, tquantity, tunit_price, trans_total)
