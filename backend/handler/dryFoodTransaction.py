...
class DryFoodTransactionHandler:
    ...
    def build_df_trans_attributes(self, df_trans_id, df_id, person_id, tquantity, tunit_price, trans_total):
        result = {
    ...
    def insertDryFoodTransaction(self, form):
        ...
        if len(form) != 4:
            ...
            if df_id and person_id and tquantity and tunit_price:
                dao = DryFoodTransactionDAO()
                df_trans_id = dao.insert(df_id,person_id,tquantity,tunit_price,trans_total)
                result = self.build_df_trans_attributes(df_trans_id, df_id, person_id, tquantity, tunit_price, trans_total)
