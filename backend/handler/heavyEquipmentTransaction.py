...
from backend.dao.medicalDeviceTransaction import HeavyEquipmentTransactionDAO
...
class HeavyEquipmentTransactionHandler:
    ...
    def build_he_trans_attributes(self, heavy_equip_trans_id, heavy_equip_id, person_id, tquantity, tunit_price, trans_total, date_completed):
        result = {
    ...
    def insertHeavyEquipmentTransaction(self, form):
        ...
        if len(form) != 4:
            ...
            if heavy_equip_id and person_id and tquantity and tunit_price:
                dao = HeavyEquipmentTransactionDAO()
                heavy_equip_trans_id = dao.insert(heavy_equip_id, person_id, tquantity, tunit_price, trans_total, date_completed)
                result = self.build_he_trans_attributes(heavy_equip_trans_id, heavy_equip_id, person_id, tquantity, tunit_price, trans_total, date_completed)
